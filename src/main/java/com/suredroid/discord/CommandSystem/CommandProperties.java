...
public class CommandProperties {
    ...
    private boolean botOwnerOnly = false, serverOwnerOnly = false;
    ...
    private void updateRoles() {
        if(Stream.of(roles).anyMatch(s -> s.toLowerCase().equals("serverowner"))) {
            serverOwnerOnly = true;
        }
        if (Stream.of(roles).anyMatch(s -> s.toLowerCase().equals("botowner"))){
            botOwnerOnly = true;
        }
    }
    ...
    public boolean isServerOwnerOnly() {
