...
public class CommandManager {
    ...
    private void gather() {
        try (ScanResult scanResult = requiredInfoGraph().scan()) {
            if(DiscordBot.debug)  System.out.println("Classes");
            ...
            for (ClassInfo routeClassInfo : routeClassInfoList) {
                if(DiscordBot.debug) System.out.print(routeClassInfo.getSimpleName() + ", ");
                addCommand(routeClassInfo.loadClass());
            }
            if(DiscordBot.debug) System.out.println();


            if(DiscordBot.debug)  System.out.println("Methods");
    ...
    private ClassGraph requiredInfoGraph() {
        ClassGraph cg = new ClassGraph().enableAnnotationInfo().enableClassInfo().enableMethodInfo().ignoreClassVisibility();
